...
export const MOCK_DISCOVERY_TESTS: DiscoveryTest[] = [
  {
    ...
    description:
      "질문 유형 선택부터 등록 완료까지 흐름이 자연스러운지 피드백 부탁드려요.",
    reward: 300,
  ...
  },
  {
    ...
    description:
      "앱을 처음 열었을 때 어떤 기능으로 보이는지 직관적으로 답해주세요.",
    reward: 500,
  ...
  },
  {
    ...
    description:
      "짧게 이미지를 본 뒤 어떤 서비스인지 얼마나 기억나는지 확인해요.",
    reward: 700,
  ...
  },
  {
    ...
    description:
      "브랜드 톤이 건강하게 느껴지는지, 혹은 부담스럽게 느껴지는지 궁금해요.",
    reward: 200,
  ...
  },
  {
    ...
    description:
      "급한 상황에서 가까운 병원을 빠르게 찾을 수 있을지 평가해주세요.",
    reward: 600,
