import { Asset, CTAButton, FixedBottomCTA, Spacing, Text, Top } from "@toss/tds-mobile";
...
// 초안은 그대로 남아있어 별도 환불 절차 없이 재시도만 하면 되므로 재시도·문의 CTA만 보여준다.
export function PaymentSystemErrorStep({ subject, onRetry, isRetrying, onContact }: Props) {
  return (
    <div className="flex flex-col h-dvh">
      ...
      <FixedBottomCTA.Double
        ...
        leftButton={
          <CTAButton color="dark" variant="weak" onClick={onRetry} loading={isRetrying}>
            다시 시도
          </CTAButton>
        }
        rightButton={
          <CTAButton color="dark" variant="weak" onClick={onContact}>
            문의하기
          </CTAButton>
        }
      />
