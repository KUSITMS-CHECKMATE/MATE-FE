...
interface CardSortQuestionEditorOverlayProps {
  initialTitle: string;
...
export function CardSortQuestionEditorOverlay({ initialTitle, initialDescription, onClose, onSave }: CardSortQuestionEditorOverlayProps) {
